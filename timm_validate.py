...
parser.add_argument('--cuda', type=str, default='0', help='gpu device number')
parser.add_argument('--divide', type=str, default='timm', help='tensor divide option')
parser.add_argument('--resize', type=str, default='resize', help='resize or resize shorter')
...
def validate(args):
    ...
    if args.model.startswith('my'):
        model = torch.hub.load('hankyul2/EfficientNetV2-pytorch', args.model[3:], pretrained=True, nclass=1000)
